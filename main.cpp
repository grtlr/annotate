...
int main( int argc, char ** argv )
{
    ...
    QCommandLineOption numberSuperpixelOption( "n", "Number of superpixels", "num", "400" );
    ...
    Files * fs = new Files( positionalArguments.at( 1 ), positionalArguments.at( 2 ) );

    // TODO Folder exists
    fs->makeLabelDir();

    AnnotationWindow window( fs->getImages().at( 0 ), "World", parser.value( "n" ).toInt() );
